...
public class LeArquivo2 {
    ...
    public static void leArquivo(String nomeArq, ListObj<Aluno> lista) {
        ...
        try {
            ...
            while (registro != null) {
                ...
                if (tipoRegistro.equals("00")) {
                    ...
                    Aluno aluno = new Aluno(ra,nomeAluno.trim(),nomeDisciplina.trim(),media,qtdFalta);
    ...
    public static void main(String[] args) {
        ListObj lista = new ListObj(10);
        String nomeArq = "ArquivoNotas.txt";
        leArquivo(nomeArq, lista);
        lista.exibe();
    }
